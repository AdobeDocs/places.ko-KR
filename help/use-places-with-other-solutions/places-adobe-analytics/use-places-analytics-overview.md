---
title: Adobe Analytics과 함께 위치 서비스 사용
...
# Adobe Analytics과 함께 위치 서비스 사용 {#places-with-aa}

Adobe Analytics에서 장소 서비스를 사용하여 다음 작업을 완료할 수 있습니다.
...
* [분석 작업 공간의 위치 데이터에 대한 보고서](/help/use-places-with-other-solutions/places-adobe-analytics/run-reports-aa-places-data.md)