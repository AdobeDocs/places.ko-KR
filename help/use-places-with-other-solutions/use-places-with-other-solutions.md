...
# 다른 Adobe 솔루션과 함께 Places Service 사용 {#use-places-other-solutions}
...
이 섹션에서는 위치 데이터를 작동 상태로 만들 수 있도록 Places Service를 다른 Experience Platform SDK 확장 프로그램과 통합하는 방법에 대해 설명합니다.