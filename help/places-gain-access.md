---
title: '장소 서비스 이용 '
description: 이 섹션에서는 사용자가 위치 서비스에 액세스할 수 있도록 위치 서비스 및 경험 플랫폼 실행에 사용자를 추가하는 방법에 대한 정보를 제공합니다.
...
Adobe Experience Cloud 홈의 [빠른 액세스 메뉴에서 위치 서비스에 액세스할](https://experience.adobe.com)수 있습니다.
사용자 ID에 액세스할 수 있는 경우, 아래와 같이 위치 서비스 아이콘이 표시됩니다.
...
1. Verify that the cards for **[!UICONTROL Adobe Experience Platform Launch]**and**[!UICONTROL Places Core Services]** are displayed.
   ...
   이러한 구성 요소가 표시되면, 사용자 조직에 대해 서비스 및 경험 플랫폼 시작이 프로비저닝된 것입니다. 표시되지 않으면 조직에 대해 프로비저닝해야 합니다.
...
### 3.사용자 또는 개발자를 Places Service 및 Experience Platform Launch 프로필에 추가

사용자 및/또는 개발자를 Places Service 및 Experience Platform 시작 프로필에 추가할 수 있습니다.
