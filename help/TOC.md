...
+ 웹 서비스 API {#web-service-api}
   ...
   + API 사용 {#api-usage}
      ...
      + 라이브러리 관리 {#manage-libraries}
         ...
         + [라이브러리 등급 다운로드](web-service-api/api-usage/manage-libraries/get-a-librarys-rank.md)
      + 관심 영역 관리 {#manage-pois}
         ...
         + [POI 보기](web-service-api/api-usage/manage-pois/read-a-poi.md)
...
+ 모바일 SDK용 익스텐션 {#places-ext-aep-sdks}
